...
const CreateEvent = () => {
    ...
    const categoryOptions = [
        'Festival', 'Entertainment', 'Sport', 'Fitness',
        'Community', 'Social', 'Concert', 'Music',
        'Art', 'Performance',
    ];
    ...
    return (
        <>
            <Navbar />
            <div className="min-h-screen bg-gray-100 flex flex-col items-center pt-10 px-8">
                <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">Create Event</h1>
                <form onSubmit={handleSubmit} className="w-full max-w-6xl bg-white p-10 rounded-lg shadow-lg space-y-8">
                    {/* Top Fields */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {/* {thumbnail && (
                                    <div className="mt-4">
                                        <p className="text-gray-700">Selected Thumbnail:</p>
                                        <img
